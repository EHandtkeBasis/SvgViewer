...
public class SvgViewer extends Composite<Div> implements HasSize<SvgViewer>, HasStyle<SvgViewer> {
  ...
  private void applyZoom() {
    ...
    // Set width and height to accommodate scaled content
    double scaledSize = zoom * 100;
    svgContainer.setStyle("width", scaledSize + "%");
    svgContainer.setStyle("height", scaledSize + "%");
  }
